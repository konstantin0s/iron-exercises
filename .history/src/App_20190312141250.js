...
class App extends Component {
  ...
  color="white"
    ...
    <button onClick={()=> {this.filteredUsers("England")}}>UK</button>
    <button onClick={()=> {this.filteredUsers("Germany")}}>Germany</button>
    <button onClick={()=> {this.filteredUsers("USA")}}>USA</button>
    <button onClick={()=> {this.filteredUsers("Malaysia")}}>Malaysia</button>
